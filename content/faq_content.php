                ...
                <div class="accordion">
                    <div class="ac-item">
                        ...
                        <div class="ac-content">
                            <div class="row">
                                <div class="col-xl-8 accordion-text-img-col">
                                ...
                                <div class="col-xl-4 accordion-text-img-col text-center">
                    ...
                    <div class="ac-item">
                        ...
                        <div class="ac-content">
                            <p>Truthfully, being a web developer didn't cross my mind when I first wanted to work in the field of technology. I immediately wanted to work with video games and be a level designer or story director. I feel like I always have stories and plot lines in my head, so the thought of bringing that to life through a video game was my biggest dream.</p>

                            <p>Still, I knew that if I wanted to work with video games, I had to start somewhere. When I was doing research for a coding bootcamp, I came across many job titles that graduates would land and a common title was "Web Developer". After doing more research into what a web developer actually did, it seemed like a fit for me - particularly the frontend side of it, because I would be able to get my feet wet with technology while still giving me the sort of creative freedom that I desired.</p>
                        </div>
                    </div>
                    <div class="ac-item">
                ...
                <div class="accordion">
                    <div class="ac-item">
                        ...
                        <div class="ac-content">
                            ...
                            <p>Fast forward to the middle of 2020 when I was unemployed and stuck indoors from the lockdown because of the pandemic. Times were tough, and I felt myself wondering what my life had become. I figured that instead of letting the days pass by, I could finally pursue my dreams of working with technology as I was already moved out from my parents' house; free to do what I want for myself. So I did research on how to get into the technical field and discovered programs called "Coding Bootcamps". From there, the rest is history! If you want to know the full in-depth story from here, you can find it on my "Education" page. </p>
                        </div>
                    </div>
                    <div class="ac-item">
                    ...
                    <div class="ac-item">
                        ...
                        <div class="ac-content">
                            <div class="row">
                                <div class="col-xl-9 accordion-text-img-col">
                                ...
                                <div class="col-xl-3 accordion-text-img-col text-center">
